...
// NOTA: No usamos HP porque causa errores de mutex en macOS/Docker
#include "QGSP_BIC.hh"
...
int main(int argc, char **argv) {
  ...
  // Fisica - QGSP_BIC para hadronterapia (sin HP para evitar mutex errors)
